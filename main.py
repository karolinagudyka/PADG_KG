...
buttom_dodaj_jednostke.grid(row=2, column=0, sticky="ew")
...
buttom_dodaj_pracownika.grid(row=2, column=0, sticky="ew")
...
buttom_dodaj_incydent.grid(row=2, column=0, sticky="ew")
...
label_formularz_incydentów.grid(row=0, column=0, columnspan=2, sticky="ew")
...
label_szczegoly_obiektu.grid(row=0, column=0, columnspan=6, sticky=W)
...
label_lokalizacja_szczegoly_obiektu.grid(row=1, column=2, sticky=W)

label_lokalizacja_szczegoly_obiektu_wartosc = Label(ramka_szczegoly_obiektu, text="...")
label_lokalizacja_szczegoly_obiektu_wartosc.grid(row=1, column=3, sticky=W)

label_posty_szczegoly_obiektu = Label(ramka_szczegoly_obiektu, text= "Posty: ")
label_posty_szczegoly_obiektu.grid(row=1, column=4, sticky=W)

label_posty_szczegoly_obiektu_wartosc = Label(ramka_szczegoly_obiektu, text="...")
label_posty_szczegoly_obiektu_wartosc.grid(row=1, column=5, sticky=W)
