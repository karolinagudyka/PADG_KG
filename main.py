...
buttom_usun_jednostke = Button(ramka_jednostki, text="Usuń", font=default_font)
buttom_usun_jednostke.grid(row=2, column=1, sticky="ew")

buttom_aktualizuj_jednostke = Button(ramka_jednostki, text="Aktualizuj", font=default_font)
...
button_dodaj_jednostke = Button(ramka_formularz_jednostki, text="Dodaj obiekt", font=default_font)
...
label_formularz_incydentów = Label(ramka_formularz_incydenty, text="Formularz - incydenty: ", font=label_font, bg="#f0c2e3")
